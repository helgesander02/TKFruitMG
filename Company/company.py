...
from .customer import right_part_A
from .item import right_part_B
...
class Company_Main_Frame(ctk.CTkFrame):
    def __init__(self, master, **kwargs):
        ...
        # right frame
        self.right_top = right_part_A(self, width=kwargs["width"]-300, height=kwargs["height"]-90, fg_color="#EEEEEE")
    ...
    def button_event_customer(self, event):
        ...
        self.right_top = right_part_A(self, width=self.w-300, height=self.h-90, fg_color="#EEEEEE")
        self.right_top.grid(row=0, column=1, padx=10, pady=10)

        
    def button_event_item(self, event):
        self.right_top.destroy()
        self.right_top = right_part_B(self, width=self.w-300, height=self.h-90, fg_color="#EEEEEE")
        self.right_top.grid(row=0, column=1, padx=10, pady=10)
