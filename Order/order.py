...
class top(ctk.CTkFrame):
    def __init__(self, master, **kwargs):
        ...
        self.cal = tkc.DateEntry(self, font=("microsoft yahei", 36))
        self.cal.place(x=450,y=60)
...
class bot(ctk.CTkFrame):
    def __init__(self, master, c_id, cal,order_id, **kwargs):
        ...
        self.btn_exit = ctk.CTkButton(self.bot_frame,width=120,height=20,text="離開", font=("microsoft yahei", 12, 'bold'))
